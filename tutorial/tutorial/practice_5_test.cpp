...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYDOWN:
	{
		...
		if (wParam == VK_NUMPAD1 or wParam == 0x31) lightflag = 1;
		if (wParam == VK_NUMPAD2 or wParam == 0x32) lightflag = 2;
	}
	break;
	case WM_LBUTTONDOWN:
	case WM_RBUTTONDOWN:
...
void Render()
{
	...
	// HW2.5) Add an option to the scene property : Paralle lighting or Point lighting
	if (lightflag == 1) cbLight.lightFlag = 1;
	else cbLight.lightFlag = 2;
